...
('Denis Mercier', 'Service client au top ! J\'ai apprécié l\'accueil et les conseils personnalisés.', 5, 1),
...
('Géraldine Mathieu', 'Équipe de vente très à l\'écoute, j\'ai trouvé le véhicule qui correspondait parfaitement à mes attentes.', 4, 1),
...
('Louis Mercier', 'Accueil personnalisé et écoute attentive. Les conseils étaient pertinents et adaptés à mes besoins.', 5, 1),
...
('Olivia Mathieu', 'Très bon accueil et grande disponibilité de l\'équipe de vente. J\'ai trouvé la voiture idéale.', 4, 1),
('Pierre Poirier', 'Je suis impressionné par le professionnalisme de l\'équipe. Service de qualité supérieure.', 5, 0),
('Sophie Martin', 'J\'ai été agréablement surprise par la rapidité du service et la qualité de l\'accueil. Le personnel était très compétent et aimable.', 5, 0),
('Xavier Dupont', 'Je suis très content de mon expérience avec ce garage. Les prix sont compétitifs et le personnel est sympathique et serviable.', 4, 0);
