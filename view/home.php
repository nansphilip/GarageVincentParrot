...
<main class="container-fluid">
    <div class="row gap-2">
        <section class="col-lg-6 p-2 bg-100 rounded-3">
            <h2>Services proposés</h2>
            <ul class="overflow-y-auto mb-1 pe-2" style="height: 55vh;">
        ...
        <section class="col p-2 bg-100 rounded-3">
            <h2>Véhicules d'occasion</h2>
            <div class="container-fluid overflow-y-auto">
                <div class="row pe-2" style="height: 55vh;">
        ...
        <section class="col-12 p-2 bg-100 rounded-3">
            <div class="d-flex justify-content-between">
                <h2>Avis client</h2>
                <button class="btn btn-primary mb-2" type="button">Ajouter un avis</button>
            </div>
            <div class="container-fluid overflow-y-auto mx-0" style="height: 21.3vh;">
                <div class="row pe-2">
